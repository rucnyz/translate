...
from model import LuongEncoder, Attn, LuongDecoder, seq2seq, BaudanauDecoder, BaudanauAttn, PlainDecoder
...
def translate_dev(i):
    ...
    zh_sent = [zh_itow[word] for word in test_zh_encode[i]]
    print('标准中文翻译：', " ".join(zh_sent))
    ...
    translation = model.translate(x, x_len, bos)
...
bleu_score = corpus_bleu(reference, hypothesis, smoothing_function=smooth.method1)
